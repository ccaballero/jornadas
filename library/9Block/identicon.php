...
class Identicon
{
    ...
    public static function png($hash, $file, $size) {
        $_GET["hash"] = $hash;
        $_GET["size"] = $size;
        ...
        $corner=Identicon::getsprite($csh,$cfr,$cfg,$cfb,$cro);
        ...
        $side=Identicon::getsprite($ssh,$sfr,$sfg,$sfb,$sro);
        ...
        $center=Identicon::getcenter($xsh,$cfr,$cfg,$cfb,$sfr,$sfg,$sfb,$xbg);
