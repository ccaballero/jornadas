...
<ul>
    ...
    <li><a accesskey="4" class="<?php echo $this->isActive($this->route, 'sponsors') ? 'active' : 'inactive' ?>" href="<?php echo $this->url(array(), 'sponsors') ?>">auspiciadores</a></li>
<?php /*    <li><a accesskey="5" class="<?php echo $this->isActive($this->route, 'propaganda') ? 'active' : 'inactive' ?>" href="<?php echo $this->url(array(), 'propaganda') ?>">propaganda</a></li> */ ?>
...
<?php } else { ?>
    <li><a accesskey="6" class="<?php echo $this->isActive($this->route, 'auth_in') ? 'active' : 'inactive' ?>" href="<?php echo $this->url(array(), 'auth_in') ?>">acceder</a></li>
<?php } ?>
</ul>
