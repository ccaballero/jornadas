<div class="post">
    ...
    <p style="min-height: 100px">
        <?php echo $this->specialEscape($this->escape($this->new->text)) ?>
    </p>

    <div class="time">
        <span class="month">
            <?php echo $this->translate($this->timestamp($this->new->tsregister, 'F')) ?>
        </span>
        <span class="day">
            <?php echo $this->timestamp($this->new->tsregister, 'd') ?>
        </span>
    </div>
