...
( 6, 'exponent', 'vladimir', 'Msc. Costas Jáuregui Vladimir',      '0H4J3UJ0', SHA1(MD5('0H4J3UJ0')), 1312522087),
( 7, 'exponent', 'jorge', 'Msc. Ing. Orellana Araoz Jorge Walter', 'JZGRABG2', SHA1(MD5('JZGRABG2')), 1312522087),
( 8, 'exponent', 'gonzalo', 'Nina Mamani Gonzalo',                 'FU64F2NT', SHA1(MD5('FU64F2NT')), 1312522087),
( 9, 'exponent', 'yony', 'Lic. Montoya Burgos Yony Richard',       '1DJIQZSG', SHA1(MD5('1DJIQZSG')), 1312522087);
...
UPDATE `exposiciones` SET `abstract` = '' WHERE ident = 5;
UPDATE `exposiciones` SET `abstract` = '' WHERE ident = 6;
