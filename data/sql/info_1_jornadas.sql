...
(1, 'seguridad-web', 'Seguridad web', 2, 1315504800, 1312522087),
(2, 'seguridad-en-redes', 'Seguridad en redes', 3, 1315508400, 1312522087),
(3, 'politicas-de-seguridad', 'Políticas de seguridad', 4, 1315512000, 1312522087),
...
(5, 'analisis-forense-en-sistema-windows', 'Análisis forense en sistemas windows', 5, 1315591200, 1312522087),
(6, 'iso-27001-orientado-a-entidades-financieras', 'ISO 27001 orientado a entidades financieras', 6, 1315594800, 1312522087),
(7, 'itil-v3', 'ITIL v3 - Gestión de seguridad de la información', 7, 1315598400, 1312522087),
(8, 'cuidado-nos-atacan-desde-dentro', 'Cuidado nos atacan desde dentro', 8, 1315602000, 1312522087);
